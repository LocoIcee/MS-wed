      ...
      <div className="mx-auto flex min-h-screen w-full max-w-6xl flex-col items-center justify-center gap-10 px-6 py-16">
        <div className="flex w-full items-center justify-center">
          <div className="grid w-full grid-cols-1 items-center gap-10 md:grid-cols-[1fr_auto_1fr]">
            <div className="page-title text-center text-4xl uppercase tracking-[0.35em] text-[#e6d8cf] lg:block font-[family-name:var(--font-quattrocento)]">
              Love
            </div>
            <div className="page-image flex justify-center">
              <Image
                src="/imgs/story.JPG"
        ...
        <div className="page-content max-w-4xl text-center text-sm lg:text-base leading-7 text-[#e6d8cf] font-[family-name:var(--font-roboto-mono)]">
          <p>
