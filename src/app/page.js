    ...
    <div className="relative min-h-screen w-full bg-[url('/imgs/home.JPG')] bg-cover bg-center text-white">
      ...
      <div className="relative flex min-h-screen flex-col items-center px-6 text-center">
        <div className="flex flex-1 flex-col items-center justify-center">
          ...
          <p className="mt-3 text-base uppercase tracking-[0.35em] text-white/90 drop-shadow-[0_4px_8px_rgba(0,0,0,0.45)] lg:text-4xl">
            Are Getting Married
          </p>
          <p className="mt-2 text-sm uppercase tracking-[0.3em] text-white/85 drop-shadow-[0_4px_8px_rgba(0,0,0,0.45)] lg:text-3xl">
